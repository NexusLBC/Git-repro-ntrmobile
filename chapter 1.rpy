...
label CH1_init:
    ...
    $ phone_set_active_conversation("maya_dm")

    $ phone_story_define("ch1_main", [

        ("msg", "maya_dm", "Maya", "Hey… t’es réveillé ?", 0, None, None, None),
        ("msg", "maya_dm", "Maya", "J’ai un souci avec mon PC", 0, None, None, None),

        # MOMENT CLÉ
        ("msg", "maya_dm", "Maya", "Haha, l'expert hardware…", 0, None, None, None),

        # ACTIONS À CE MOMENT PRÉCIS
        ("act", create_phone_channel("elias_dm", "Elias", ["Elias", phone_config["phone_player_name"]], "avatars/elias_icon.png")),
        ("act", phone_set_active_conversation, ("elias_dm",), {}),
        ("act", phone_lock_conversation, ("maya_dm", True), {}),
    ])

    $ phone_story_bind_channel("maya_dm", "ch1_main")
    $ phone_story_bind_channel("elias_dm", "ch1_main")

    $ phone_story_pump("ch1_main")
...
#     $ send_phone_message("Maya", "Attends, j'ajoute un sticker pour toi. <emoji_dizzy>", "maya_dm", do_pause=False)
...
#     $ phone_set_active_conversation("elias_dm")
