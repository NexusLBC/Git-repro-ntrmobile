...
image lock_wallpaper = "gui/lock_wallpaper.png"
...
init python:
    ...
    BUTTON_WIDTH = 215
    BUTTON_HEIGHT = 215
    FRAME_WIDTH = SLIDER_WIDTH
    FRAME_HEIGHT = SLIDER_HEIGHT
    ...
    # Fonction appelée pendant le drag du bouton
    def unlock_dragged(drags, drop):
        d = drags[0]
